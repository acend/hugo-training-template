...
LABEL org.opencontainers.image.description "Container with the Training Content for acend.ch's CHANGEME Training"
LABEL org.opencontainers.image.authors acend.ch
LABEL org.opencontainers.image.authors https://github.com/acend/changeme-training/
